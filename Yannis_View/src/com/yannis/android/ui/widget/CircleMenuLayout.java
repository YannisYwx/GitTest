...
public class CircleMenuLayout extends ViewGroup
{
	...
	private static final String TAG="CirleMenu";
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		Log.d("CirleMenu", "width:"+width+" height:"+height);


		/**
		 * 如果宽或者高的测量模式非精确值
		 * 如果不是精准测量（包括match_parent） 【说明设置为wrap_content】先判断有没有背景 没有的画就设置为
		 */
				...
				|| heightMode != MeasureSpec.EXACTLY)
		{
			...
			Log.d("CirleMenu", "resWidth:"+resWidth+"EXACTLY [widthMode:"+(widthMode == MeasureSpec.EXACTLY)+
					" heightMode:"+(widthMode == MeasureSpec.EXACTLY)+"]");
			...
			Log.d("CirleMenu", "resWidth:"+resWidth+" resHeight:"+resHeight);

		} else
		{
			// 如果都设置为精确值（包括match_parent），则直接取小值；
		...
		Log.d(TAG, "mRadius:"+mRadius+"-getMeasuredWidth:"+getMeasuredWidth()+" getMeasuredWidth:"+getMeasuredWidth());
		// menu item数量
		...
		Log.d(TAG, "getChildCount:"+count+"-childSize:"+childSize+" childMode:"+MeasureSpec.EXACTLY);
